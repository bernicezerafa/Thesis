...
public class FileHelper {
	...
	@SuppressWarnings("unchecked")
	public static HashMap<IntTuple, ArrayList<String>> getClashesMatrix()
	{
		ObjectInputStream inputStream = null;
		HashMap<IntTuple, ArrayList<String>> clashesMatrix = null;
		
		try
		{
			inputStream = FileHelper.getObjectReader("clashesMatrix.data");
			clashesMatrix = (HashMap<IntTuple, ArrayList<String>>) inputStream.readObject();
		}
		catch (Exception e)
		{
	...
	public static void saveClashesMatrix(HashMap<IntTuple, ArrayList<String>> clashesMatrix)
	{
		ObjectOutputStream outputStream = null;
	...
	public static void saveChromosomeBefore(BestChromosome chromosome)
	{
		ObjectOutputStream outputStream = null;
	...
	public static BestChromosome getChromosomeBefore()
	{
		ObjectInputStream inputStream = null;
		...
		try
		{
			...
			bestChromosome = (BestChromosome) inputStream.readObject();
		}
		catch (Exception e)
		{
	...
	public static void saveBestChromosome(BestChromosome chromosome)
	{
		ObjectOutputStream outputStream = null;
	...
	public static BestChromosome getBestChromosome()
	{
		ObjectInputStream inputStream = null;
		BestChromosome bestChromosome = null;
